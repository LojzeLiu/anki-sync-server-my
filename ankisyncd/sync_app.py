...
import ankibundled.anki
import ankibundled.anki.db
import ankibundled.anki.sync
import ankibundled.anki.utils
from ankibundled.anki.consts import SYNC_VER, SYNC_ZIP_SIZE, SYNC_ZIP_COUNT
from ankibundled.anki.consts import REM_CARD, REM_NOTE
...
class SyncCollectionHandler(anki.sync.Syncer):
    ...
    def meta(self, v=None, cv=None):
        ...
        # 这个 col 在 anki-sync-server\ankibundled\anki\collection.py
        # media 在 anki-sync-server\ankibundled\anki\media.py
